> **Historical design reference.** This is the former root README, preserved for visual and architecture context. Its feature counts and setup details may be outdated; use the [current README](../README.md) and source code for current behavior.
